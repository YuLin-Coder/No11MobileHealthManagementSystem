...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body leftmargin="8" topmargin='8' onload="noteAlert()">
		<form id="form" action="<%=path%>/AdminServlet?action=editSave" method="post">
		<input type="hidden" name="id" id="id" value='<c:out value="${admin.id}"></c:out>'/>
				...
				<tr bgcolor="#FFFFFF">
					...
					<td width="38%">
						<input type="text" ID="loginpsw" name="loginpsw" Height="21px"
							Width="196px"  value='${admin.loginpsw}'/>
					</td>
				</tr>
				<tr bgcolor="#FFFFFF">
					<td width="12%" align="center">
					...
					<td width="38%">
						<input type="text" ID="username" name="username"  value='${admin.username}'  Height="21px" Width="196px" />
						</td>
				</tr>
