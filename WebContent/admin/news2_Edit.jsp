...
<html>
	...
	<body leftmargin="8" topmargin='8'>	    
		<form id="form" action="<%=path%>/News2Servlet?action=editSave" method="post">
		<input type="hidden" name="id" id="id" value='<c:out value="${news2.id}"></c:out>'/>
			...
			<table width="98%" align="center" border="0" cellpadding="4"
				...
				<tr bgcolor="#FFFFFF">
					...
					<td width="90%">
						<input type="text" ID="title" name="title" Height="21px"
							style="width: 200px"  value='<c:out value="${news2.title}"></c:out>'/>
				...
				<tr bgcolor="#FFFFFF">
					...
					<td width="90%">
						<input type="text" ID="imgpath" name="imgpath"  Height="21px" readonly="readonly"
							style="width: 200px"  value='<c:out value="${news2.imgpath}"></c:out>'/>
				...
				<tr bgcolor="#FFFFFF">
					...
					<td width="90%">
						<textarea id="content" name="content" rows="" cols=""> <c:out value="${news2.content}"></c:out></textarea>
					</td>
				</tr>
				<tr bgcolor="#FFFFFF">
					<td align="center">
					...
					<td colspan="3">
						...
						&nbsp;
						<a href="News2Servlet?action=list" target="right">返回列表</a>
					</td>
				</tr>
			</table>
